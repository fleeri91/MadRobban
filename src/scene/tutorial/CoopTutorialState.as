package scene.tutorial {
	...
	/**
	 *	Tillstånd för co-op tutorial
	 */
	public class CoopTutorialState extends DisplayState {
		
		// --------------------------------------------------------
		// Private Properties
		// --------------------------------------------------------
		private var _controls:EvertronControls = new EvertronControls;
		private var _introAnimation:TutorialCoop;
		...
		// Constructor Method
		// --------------------------------------------------------
		public function CoopTutorialState() {
			this.initLayers();
		...
		private function initTutorialAnimation():void {
			this._introAnimation = new TutorialCoop();
